...
import com.incture.iopptw.dtos.PermitsByLocDataDto;
import com.incture.iopptw.dtos.PermitsByLocInnerDto;
import com.incture.iopptw.dtos.PermitsByLocPayloadDto;
import com.incture.iopptw.dtos.PermitsByLocRecordDto;
		...
		try {
			...
			for (Object[] d : sqlData) {
				...
				logger.info("PermitsByLocDao | getPermitsByLoc | temp " + temp.getCreatedBy() + temp.getFacilityorsite()
						+ temp.getJsaPermitNumber() + temp.getPermitNumber() + temp.getPtwPermitNumber()
						+ temp.getStatus() + temp.getIsCse() + temp.getIsCwp() + temp.getIsHwp());
			}
