...
//		List<Object[]> obj;
		...
		try{
			...
			JsaHazardsPressurizedDto jsaHazardsPressurizedDto = jsaHazardsPressurizedDao.getjsaHazardsPress(permitNumber);
			...
			JsaHazardsVisibilityDto jsaHazardsVisibilityDto = jsaHazardsVisibilityDao.getJsaHazardsVisible(permitNumber);
			...
			JsaHazardsSimultaneousDto jsaHazardsSimultaneousDto = jsaHazardsSimultaneousDao.getJsaHazardsSimultan(permitNumber);
			...
			JsaHazardsSubstancesDto jsaHazardsSubstancesDto = jsaHazardsSubstancesDao.getJsaHazardsSubstances(permitNumber);
			...
			JsaHazardsHighNoiseDto jsaHazardsHighNoiseDto = jsaHazardsHighNoiseDao.getJsaHazardsHighNoiseDto(permitNumber);
			...
			JsaHazardsElectricalDto jsaHazardsElectricalDto = jsaHazardsElectricalDao.getJsaHazardsElectricalDto(permitNumber);
