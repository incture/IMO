...
sap.ui.define([
	"sap/ui/core/Control",
	"com/sap/incture/Incture_IOP/util/BoxContainerList",
	"com/sap/incture/Incture_IOP/util/BoxContainerRenderer"
	 ...
	 */
	var BoxContainer = Control.extend("com.sap.incture.Incture_IOP.util.BoxContainer", {
		metadata: {
			properties: {
			...
			aggregations: {
				 ...
				 */
				boxes: {
					type: "com.sap.incture.Incture_IOP.util.Box",
					multiple: true,
					singularName: "box",
					bindable: "bindable",
					forwarding: {
