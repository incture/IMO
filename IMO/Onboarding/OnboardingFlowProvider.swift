...
//            self.configuredUserConsentStep(),
    ...
    private func configuredWelcomeScreenStep() -> WelcomeScreenStep {
        ...
        let discoveryConfigurationTransformer = DiscoveryServiceConfigurationTransformer(applicationID: "com.dft.native", authenticationPath: "com.OData.dest")
        ...
        welcomeScreenStep.welcomeScreenCustomizationHandler = { welcomeScreen in
            welcomeScreen.headlineLabel.text = "IMO-DFT"
