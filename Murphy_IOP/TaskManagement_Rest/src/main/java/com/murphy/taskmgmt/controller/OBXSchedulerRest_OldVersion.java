...
//public class OBXSchedulerRest_OldVersion {
//
//	/*@Autowired
//	ObxSchedulerFacadeLocalDummy obxDummy;*/
//	
//	@Autowired
//	ObxSchedulerFacadeLocal obx;
//	
//	/*@RequestMapping(value="/generateWellVisitMatrix_Old", method = RequestMethod.GET)
//	public void generateWellVisitMatrix(){
//		System.err.println("Entering obx.generateWellVisitMatrix()");
//		obxDummy.generateWellVisitMatrix();
//	}*/
////	
...
//		return obx.createOBXTask(userId, location);
//	}
//	
...
////		System.err.println("OBXSchedulerRest.getNearbyAssignedTask(" + latitude + ", " + longitude + ")");
...
//	}
//	
////	@RequestMapping(value = "/createUserJobsK_Means", method = RequestMethod.GET)
...
////	public String updateSequence(@RequestParam(value = "role", required = true) String role) {
////		obx.updateTaskSequence(role);
////		return "Success";
////	}
//	
//	
////	@RequestMapping(value="/generateTaskAllocation",method = RequestMethod.GET)
////	public void CreateTaskAllocation(){
////		obx.CreateTaskAllocation();
////	}
//	
...
////	Double updateTask(@RequestParam(value = "userId", required = true) String userId,
////			@RequestParam(value = "locationCode", required = true) String locationCode) {
////		// LOGGER.info("Inside delivery data creation");
////		return obx.getDistance(userId,locationCode);
////	}
//	
...
//		}
//		
////		@RequestMapping(value="/reAssignWells",method = RequestMethod.POST)
////		public String reAssignWells(@RequestBody List<String> fields){
////			obx.reAssignWells(fields);
////			return "Success";
////		}
//		
//		
